...
public class AdminController {
    ...
    public String updateUser(@PathVariable("id") String id, @Valid User user, BindingResult errors, Model model, RedirectAttributes flash) {
    ...
    public boolean duplicateUser(@RequestParam("email") String email) throws ParseException {
        return userService.getAllUserMailData(email, userId);
    }
