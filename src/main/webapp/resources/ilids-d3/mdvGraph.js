...
//                d = x0 - dateFormat(d0.date) > dateFormat(d1.date) - x0 ? d1 : d0;
//        var pdatee = dateFormat(d.date);
//        focus.select("circle.y0").attr("transform", "translate(110,240)");
//        focus.select("text.y0").attr("transform", "translate(200,700)").text(formatOutput0(d));
//        focus.select("circle.y1").attr("transform", "translate(100,200)");
//        focus.select("text.y1").attr("transform", "translate(" + main_x(d.pdatee) + "," + main_y1(+d.mdv) + ")").text(formatOutput1(d));
//        focus.select(".x").attr("transform", "translate(" + main_x(pdatee) + ",0)");
//        focus.select(".y0").attr("transform", "translate(" + main_width * -1 + ", " + main_y0(+d.current) + ")").attr("x2", main_width + main_x(pdatee));
//        focus.select(".y1").attr("transform", "translate(0, 100)").attr("x1", "200");
//    }
...
//		minX = -(((main_x.domain()[0]-main_x.domain()[1])*zoom.scale())+(panExtent.x[1]-(panExtent.x[1]-(main_width/divisor.w)))),
