...
d3.json(servlet, function(data) {
    ...
    var formatDate = d3.time.format("%H:%M:%S"),
            ...
            formatOutput0 = function(d) {
                return formatDate(dateFormat(d.date)) + " - " + +d.current + "  Duration " + d.d;
            },
            
            formatOutput1 = function(d) { 
                return formatDate(dateFormat(d.date)) + " - " + +d.mdv; 
            },
            formatCurrency = function(d) { return "d.difference"; };
...
//    .enter().append("rect")
//      .attr("class", "bar")
//      .attr("x", function(d) { return main_x(dateFormat(d.date)); })
//      //.attr("width",x.rangeBand())
//      .attr("y", function(d) { return main_y0(+d.current); })
//      .attr("height", function(d) { return main_height - main_y0(+d.current); })
...
//    .enter().append("circle")                               
//        .attr("r", 5)       
//        .attr("cx", function(d) { return main_x(dateFormat(d.date)); })       
//        .attr("cy", function(d) { return main_y0(d.current); })     
//        .on("mousedown", function(d) { 
//            alert("---");
//            div.transition()        
//                .duration(200)      
//                .style("opacity", .9);      
//            div .html(dateFormat(d.date) + "<br/>"  + d.current)  
...
//       
//
//         focus.attr("transform", "translate(" + main_x(pdatee) + "," + main_y0(+d.current) + ")");
//         focus.select("text").text(formatCurrency(+d.current));
//          
